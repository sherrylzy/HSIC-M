...
def hsicm_learner(cfeatures, pre_features, pre_weight1, args, global_epoch=0, iter=0):
    ...
    if global_epoch == 0 and iter < 10:
        ...
        pre_features = pre_features * args.presave_ratio + features * (1 - args.presave_ratio)
